 ...
 * 
 */
public class LoadCommentSeries {

  /** The file location. */
  private static final String fileLocation = "/media/Stock/stack/xml/comments.xml";
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.err.println("Loading simplified comments from StackOverflow posts table dump.");
        ...
        while (xmlStreamReader.hasNext()) {
          ...
          if ((XMLStreamConstants.END_ELEMENT == eventCode)
            ...
            if ((XMLStreamConstants.START_ELEMENT == eventCode)
              ...
              CommentSeries record = new CommentSeries();
              ...
              if (recordCounter % 20000 == 0) {
                ...
                System.err.println("+20K comment records loaded and saved, total records: "
                    + recordCounter);
