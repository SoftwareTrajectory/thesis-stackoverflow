...
public class PostSeries2EventTrails {
  ...
  static {
    consoleLogger = (Logger) LoggerFactory.getLogger(PostSeries2EventTrails.class);
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (String tzname : targetTimeZones) {
      ...
      for (User u : users) {
        ...
        //
        final PostSeriesJob job = new PostSeriesJob(u, ps, tzname);
